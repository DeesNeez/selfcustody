...
const ui = () => `
  ...
  function paintDistribution(input, progress) {
    ...
    caveat.textContent = 'Advisory only. This cannot prove a die is fair. Do not edit or reroll individual outcomes in response; test the physical die in a separate run if something concerns you.';
