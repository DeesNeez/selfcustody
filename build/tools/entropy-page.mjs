...
${FONTS.map(embedFont).join('\n')}
  ...
  * { box-sizing: border-box; }
  ...
  .export-tag {
    display: block; width: fit-content; margin-bottom: 4px; padding: 3px 8px; border-radius: 999px;
    color: var(--muted); background: rgba(255, 255, 255, 0.06);
    font-size: 0.7rem; font-weight: 800; line-height: 1.25; letter-spacing: 0.075em; text-transform: uppercase;
  }
  .is-private .export-tag { color: #ffad9c; background: rgba(214, 94, 64, 0.21); }
  .is-watch .export-tag { color: #9af0d3; background: rgba(53, 180, 138, 0.21); }
  .export-card h4 { margin: 0; color: #fff; font-size: 1rem; }
