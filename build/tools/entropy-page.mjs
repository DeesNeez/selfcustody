...
${FONTS.map(embedFont).join('\n')}
  ...
  * { box-sizing: border-box; }
  ...
  .address-match input[type="text"] {
    margin-top: 10px;
    border-color: rgba(205, 176, 110, 0.30);
  }
...
<details id="sources">
  ...
  <div class="body">
    ...
    <p class="src-tail">The per-release beta acknowledgement adapts merged <a href="https://github.com/w-s-bitcoin/entropylab/pull/106" target="_blank" rel="noopener noreferrer">EntropyLab pull request #106</a>. The in-page warning and its wording are specific to this Workshop.</p>
